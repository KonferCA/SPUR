                ...
                <Container>
                    <div className="text-center max-w-4xl mx-auto py-20">
                        ...
                        <p className="text-xl text-gray-600 mb-8">
                            SPUR helps startups navigate the Web3 ecosystem,
                            find funding opportunities, and connect with the
                            right partners to accelerate their growth.
                        </p>
                        <div className="flex justify-center space-x-4">
                            <Link
                                to="/auth"
                                className="inline-flex items-center px-6 py-3 bg-gray-900 text-white rounded-md hover:bg-gray-800"
                            >
                                Start Now
                            ...
                            <button
                                onClick={() =>
                                    alert('TODO: make this button do something')
                                }
                            ...
                            <Grid columns={2} gap="large">
                                <div className="p-8 bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col items-center text-center">
                                    ...
                                    <p className="text-gray-600">
                                        Access a worldwide network of Web3
                                        investors, mentors, and partners ready
                                ...
                                <div className="p-8 bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col items-center text-center">
                                    ...
                                    <p className="text-gray-600">
                                        Our smart matching system connects you
                                        with the perfect partners for your
                                        startup's needs.
                                    </p>
                                </div>
                                <div className="p-8 bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col items-center text-center">
                                    ...
                                    <p className="text-gray-600">
                                        Discover and apply to funding
                                        opportunities tailored to your startup's
                                        stage and goals.
                                    </p>
                                </div>
                                <div className="p-8 bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col items-center text-center">
                                    ...
                                    <p className="text-gray-600">
                                        Connect with thoroughly vetted partners
                                        and investors to ensure secure and
                            ...
                            <Stack gap="lg">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">
                                            Set up your startup's profile with
                                            key information about your team,
                                            vision, and goals.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">
                                            Link your Web3 wallet to access the
                                            full range of SPUR's features and
                                            opportunities.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">
                                            Browse through curated opportunities
                    ...
                    <div className="py-20">
                        <div className="max-w-5xl mx-auto text-center">
                            ...
                            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                                Everything you need to succeed in the Web3
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div className="p-6 rounded-lg">
                                    ...
                                    <p className="text-gray-600">
                                        Access to thoroughly vetted Web3
                                        investors and partners ready to support
                                        your growth.
                                    </p>
                                </div>
                                <div className="p-6 rounded-lg">
                                    ...
                                    <p className="text-gray-600">
                                        Our intelligent system connects you with
                                        opportunities that match your startup's
                                        needs.
                                    </p>
                                </div>
                                <div className="p-6 rounded-lg">
                                ...
                                <div className="p-6 rounded-lg">
                                    ...
                                    <p className="text-gray-600">
                                        Access to resources, guides, and
                                ...
                                <div className="p-6 rounded-lg">
                                    ...
                                    <p className="text-gray-600">
                                        Join networking events and workshops to
                                ...
                                <div className="p-6 rounded-lg">
                                    ...
                                    <p className="text-gray-600">
                                        Built with security and transparency at
                                        its core for peace of mind.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <Section>
                <Container>
                    <div className="text-center max-w-3xl mx-auto py-20">
                        ...
                        <p className="text-xl text-gray-600 mb-8">
                            Join SPUR today and connect with the opportunities
                            that will take your startup to the next level.
                        </p>
                        <Link
                            to="/auth"
                            className="inline-flex items-center px-8 py-4 bg-gray-900 text-white rounded-md hover:bg-gray-800 text-lg"
                        >
                            Get Started Now
                            <FiArrowRight className="ml-2" />
                        </Link>
                ...
                <Container className="max-w-7xl mx-auto">
                    <div className="py-12">
                        ...
                        <div className="border-t border-gray-200 mt-12 pt-8 text-center text-gray-600">
                            <p>
                                &copy; {new Date().getFullYear()} SPUR. All
                                rights reserved.
                            </p>
                        </div>
                    </div>
